...
<head>
    ...
    <meta charset="UTF-8">
  <title>Sistem Legalisir FATISDA</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

  <link href="https://fonts.googleapis.com/css?family=Work+Sans:300,400,,500,600,700" rel="stylesheet">

  <link rel="stylesheet" href="css/alumni/css/open-iconic-bootstrap.min.css">
  <link rel="stylesheet" href="css/alumni/css/animate.css">

  <link rel="stylesheet" href="css/alumni/css/owl.carousel.min.css">
  <link rel="stylesheet" href="css/alumni/css/owl.theme.default.min.css">
  <link rel="stylesheet" href="css/alumni/css/magnific-popup.css">

  <link rel="stylesheet" href="css/alumni/css/aos.css">

  <link rel="stylesheet" href="css/alumni/css/ionicons.min.css">

  <link rel="stylesheet" href="css/alumni/css/bootstrap-datepicker.css">
  <link rel="stylesheet" href="css/alumni/css/jquery.timepicker.css">


  <link rel="stylesheet" href="css/alumni/css/flaticon.css">
  <link rel="stylesheet" href="css/alumni/css/icomoon.css">
  <link rel="stylesheet" href="css/alumni/css/style.css">
</head>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">FATISDA</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="about.html" class="nav-link">Ajuan</a></li>
          <li class="nav-item active"><a href="domain.html" class="nav-link">Profile</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <section class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(images/ppl.png);">
      <div class="overlay"></div>
      <div class="container-fluid">
        <div class="row slider-text align-items-center" data-scrollax-parent="true">

          <div class="col-md-8 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4 mt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Selamat datang di
              SISTEM LEGALISIR ONLINE FATISDA UNS</h1>
            <p class="mb-4 mb-md-5 sub-p" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Sistem
              legalisir online merupakan sistem yang dibuat dengan tujuan memberikan kemudahan bagi alumni Fakulltas
              Teknologi Informasi dan Sains Data UNS untuk melakukan legalisir secara online</p>
            <p>
              <!-- <a href="#" class="btn btn-primary p-3 px-xl-5 py-xl-3">Get started</a>  -->
              <a href="#" class="btn btn-primary btn-primary-2 p-3 px-xl-5 py-xl-3">Ajukan Legalisir</a></p>
          </div>
          <div class="col-md-3 ftco-animate">
            <img src="images/alumni.png" class="img-fluid" alt="">
          </div>
  ...
  <section class="ftco-services">
    <div class="container-wrap">
      <div class="row no-gutters">
        <div class="col-lg-5 img services-img" style="background-image: url(images/bg_1.jpg);"
          data-stellar-background-ratio="0.5">
      ...
      <div class="row">
        ...
        <strong>Copyright &copy; Fakultas Teknologi Informasi Dan Sains Data - 2023 </strong>
          ...
          <!-- <p>Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0.
            ...
            <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Kelompok 1 PPL A</a>
  ...
  <script src="css/alumni/js/jquery.min.js"></script>
  <script src="css/alumni/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="css/alumni/js/popper.min.js"></script>
  <script src="css/alumni/js/bootstrap.min.js"></script>
  <script src="css/alumni/js/jquery.easing.1.3.js"></script>
  <script src="css/alumni/js/jquery.waypoints.min.js"></script>
  <script src="css/alumni/js/jquery.stellar.min.js"></script>
  <script src="css/alumni/js/owl.carousel.min.js"></script>
  <script src="css/alumni/js/jquery.magnific-popup.min.js"></script>
  <script src="css/alumni/js/aos.js"></script>
  <script src="css/alumni/js/jquery.animateNumber.min.js"></script>
  <script src="css/alumni/js/bootstrap-datepicker.js"></script>
  <script src="css/alumni/js/jquery.timepicker.min.js"></script>
  <script src="css/alumni/js/scrollax.min.js"></script>
  <script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="css/alumni/js/google-map.js"></script>
  <script src="css/alumni/js/main.js"></script>
