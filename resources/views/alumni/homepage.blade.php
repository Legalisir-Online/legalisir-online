            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Modal Success Notification</h5>
    ...
    <section class="features">
        ...
        <div class="feature2">
            ...
            <div class="feature2-content">
                <p>Sistem legalisir online merupakan sistem yang dibuat dengan tujuan memberikan kemudahan bagi alumni
                    Fakulltas Teknologi Informasi dan Sains Data UNS untuk melakukan legalisir secara online.</p>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-btn">
                            <button type="button" id="upload"
                                style="background-color: #5676E1; color:white; border-radius: 10px;">Upload
                                Berkas</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn"
                            style="background-color: #5676E1; color:white; border-radius: 10px;">Upload Berkas</button>
                    </div>
                </div>
            </div>
        </div>
